...
const createTalents = async (req) => {
  ...
  // apa bila check true / data talents sudah ada maka tampilkan error bad request dengan message talents sudah terdaftar!
  if (check) throw new BadRequestError('talents sudah terdaftar!');
...
const updateTalents = async (req) => {
  ...
  // apa bila check true / data talents sudah ada maka kita tampilkan error bad request dengan message talents sudah terdaftar!
  if (check) throw new BadRequestError('talents sudah terdaftar!');
